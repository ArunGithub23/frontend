import { WindowsOutlined ,PlusSquareOutlined ,HomeFilled,CloseSquareOutlined} from '@ant-design/icons';
...
const items = [
  ...
  getItem(<Link to='/delete'> DELETE_PRODUCT</Link>, 'sub3', <CloseSquareOutlined />),
